...
const projects = [
  { name: "GRIDPULSE", description: "An evidence-first infrastructure intelligence control plane combining telemetry validation with Azure Machine Learning and Microsoft Foundry.", url: "https://gridpulse-three.vercel.app/" },
...
const personJsonLd = {
  ...
  knowsAbout: ["Web development", "Artificial intelligence", "Software development", "Product design", "User interface design", "Content creation", "Infrastructure intelligence"], mainEntityOfPage: `${siteUrl}/about`,
};
  ...
  return (
    <main className="min-h-screen bg-[#050505] px-6 py-16 text-white sm:px-10 lg:px-20">
      <div className="mx-auto max-w-5xl">
        <Link href="/" className="text-xs uppercase tracking-[0.24em] text-white/35 hover:text-white/70">← Back to portfolio</Link>
        <header className="mt-24 max-w-4xl"><p className="text-xs uppercase tracking-[0.3em] text-white/30">About</p><h1 className="mt-6 text-5xl font-semibold tracking-[-0.06em] sm:text-7xl">Koglesh R. Murugan</h1><p className="mt-8 max-w-2xl text-lg leading-8 text-white/50">Independent developer and product builder creating real-world web products, AI experiences, infrastructure intelligence and creative digital projects.</p></header>
